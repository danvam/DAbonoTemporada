...
export const RegisterPage = (props: IRegisterProps) => {
  ...
  const handleValidSubmit = (event, values) => {
    props.handleRegister(values.username, values.email, values.firstPassword, values.direccion, props.currentLocale);
      ...
      <Row className="justify-content-center">
        <Col md="8">
          <AvForm id="register-form" onValidSubmit={handleValidSubmit}>
            ...
            <AvField
              name="direccion"
              label={translate('global.form.direccion.label')}
              placeholder={translate('global.form.direccion.placeholder')}
              type="direccion"
              validate={{
                required: { value: true, errorMessage: translate('global.messages.validate.direccion.required') },
              }}
            />
            <AvField
              name="firstPassword"
