...
import es.blockchain.abono.config.audit.AuditEventConverter;
import es.blockchain.abono.domain.PersistentAuditEvent;
...
import static es.blockchain.abono.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
