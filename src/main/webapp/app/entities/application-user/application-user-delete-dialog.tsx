...
export const ApplicationUserDeleteDialog = (props: IApplicationUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="abonoBlockchainApp.applicationUser.delete.question">
        <Translate contentKey="abonoBlockchainApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
